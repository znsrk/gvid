...
app.post('/api/modify-plugin-code', async (req, res) => {
  try {
    ...
    const systemPrompt = `You are an expert JavaScript plugin developer. The user wants to modify their OqyPlus plugin code based on their request.
...
OqyPlus Plugin Structure Reference:
